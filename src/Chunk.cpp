...
Chunk::Chunk(glm::ivec3 pos) : m_Pos(pos)
{
    ...
    m_ModelMatrix = glm::translate(glm::mat4(1.f),
                                   glm::vec3(pos.x * WIDTH,
                                             pos.y * HEIGHT,
                                             pos.z * DEPTH));
    // KORRIGIERT: Enum-Klasse verwenden
        ...
        for (int y = 0; y < HEIGHT; ++y)
            for (int x = 0; x < WIDTH; ++x)
            {
                ...
                for (int d = 0; d < 6; ++d)
                {
                    ...
                    if (getBlock(n.x, n.y, n.z) != 0) continue;
                    switch (d) {
                    case 0: addQuad(p + glm::vec3(1,0,0), p + glm::vec3(1,0,1), p + glm::vec3(1,1,1), p + glm::vec3(1,1,0)); break;
                    case 1: addQuad(p + glm::vec3(0,0,1), p + glm::vec3(0,0,0), p + glm::vec3(0,1,0), p + glm::vec3(0,1,1)); break;
                    case 2: addQuad(p + glm::vec3(0,1,1), p + glm::vec3(1,1,1), p + glm::vec3(1,1,0), p + glm::vec3(0,1,0)); break;
                    case 3: addQuad(p + glm::vec3(0,0,0), p + glm::vec3(1,0,0), p + glm::vec3(1,0,1), p + glm::vec3(0,0,1)); break;
                    case 4: addQuad(p + glm::vec3(0,0,1), p + glm::vec3(1,0,1), p + glm::vec3(1,1,1), p + glm::vec3(0,1,1)); break;
                    case 5: addQuad(p + glm::vec3(1,0,0), p + glm::vec3(0,0,0), p + glm::vec3(0,1,0), p + glm::vec3(1,1,0)); break;
                    }
                }
            }
...
bool Chunk::uploadMesh(VulkanRenderer &renderer)
{
    ...
    renderer.createChunkMeshBuffers(m_Vertices, m_Indices, m_Upload, 

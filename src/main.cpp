...
private:
    ...
    void initVulkan()
    {
        ...
        createSyncObjects(); // NEUER LETZTER SCHRITT
    }
    ...
    void mainLoop()
    {
        ...
        vkDeviceWaitIdle(device); // Warten, bis die GPU fertig ist
    }
    ...
    // --- HELPER FUNCTIONS IN CORRECT ORDER ---
    ...
    bool checkDeviceExtensionSupport(const VkPhysicalDevice &pdevice)
    {
